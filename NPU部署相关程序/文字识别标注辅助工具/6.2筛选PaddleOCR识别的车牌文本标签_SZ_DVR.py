...
rec_file_path = r'D:\迅雷下载\AI数据集汇总\汽车拍照检测识别\detect_car_brand_crops\all_detect_crops_database_labels_file\detect_SZ_DVR_car_brand_crops_focus_8_pt_labels.txt'
