...
def image_resize(image_path, new_path):  # 统一图片尺寸
    ...
    for img_name in os.listdir(image_path):
        ...
        image = image.resize((1024, 576))  # 设置需要转换的图片大小
...
if __name__ == '__main__':
    print("ready for ::::::::  ")
    ori_path = r"D:\中星微人工智能工作\ykang_plate_det_rec\ykang_plate_det_rec\test_data_face_yk"  # 输入图片的文件夹路径
    new_path = r'D:\中星微人工智能工作\ykang_plate_det_rec\ykang_plate_det_rec\test_data_face_yk_reshape'  # resize之后的文件夹路径
